 ...
 */
public class SendImageViewHolder extends XViewHolder<Message> {
    private BubbleImageView bubbleImageView;

    public SendImageViewHolder(final View itemView) {
        super(itemView);
        bubbleImageView = (BubbleImageView) itemView.findViewById(R.id.tv_msg_list_item_img_to_content);
